...
public class ProcessorRoute extends RouteBuilder {
  ...
  @Autowired
  public void setProcessor(NotificationProcessor processor) {
  ...
  public void configure() throws Exception {
    ...
    from("{{next.queue}}")
        .id("ProcessorRoute")
        .convertBodyTo(NotificationData.class)
        .log(LoggingLevel.INFO, NotificationData.class.getName(), "Processing transformed notification : ${body} ")
